...
import { BedDouble, LayoutDashboard, CalendarCheck, Users, Wallet, BarChart3, ListTodo, MessageCircle, Settings, LifeBuoy } from "lucide-react";
    ...
    <aside className="hidden lg:flex w-64 shrink-0 flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-border">
      <div className="h-16 px-5 flex items-center gap-2 border-b border-sidebar-border">
        ...
        <div>
          ...
          <div className="text-[10px] uppercase tracking-widest text-sidebar-foreground/50">Pro · Mumbai</div>
        </div>
      </div>
      ...
      <div className="p-3 border-t border-sidebar-border space-y-0.5">
        ...
        <div className="mt-3 flex items-center gap-3 rounded-lg px-3 py-2 bg-sidebar-accent/40">
          <div className="h-8 w-8 rounded-full bg-primary/20 grid place-items-center text-xs font-semibold text-primary">RK</div>
          <div className="min-w-0">
            <div className="text-sm font-medium truncate">Riya Kapoor</div>
            <div className="text-[11px] text-sidebar-foreground/60 truncate">Owner</div>
          </div>
        </div>
      </div>
    </aside>
